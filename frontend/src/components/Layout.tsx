// App shell: top bar with brand, a live backend health LED, and a settings dialog to
// point the app at any backend (Render cloud, or your laptop via a Cloudflare tunnel /
// localhost) with a built-in health test — no rebuild needed.
    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-slate-900/30 p-4 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <p className="mt-1 text-sm text-slate-500">
          Point the app at any backend — the cloud (Render) or your laptop via a Cloudflare
          tunnel / localhost. Saved to this browser; no rebuild needed.
        </p>
        ...
        <input
          ...
          placeholder="https://<tunnel>.trycloudflare.com   or   http://localhost:8000"
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      {open && <BackendSettings onClose={() => setOpen(false)} />}
