...
class Field(Base):
    ...
    is_verified: Mapped[bool] = mapped_column(Boolean, default=False)  # corroborated by calc / second value
    verified_reason: Mapped[str | None] = mapped_column(String, nullable=True)
